...
class ContactServiceTest {
	...
	/*callAddContact passing the first, last, phone, address then validate it works using getters validate that the ArryList is not empty*/
	...
	/*Add 3 contacts via addContact delete object at id 1 check that there is no object there*/
	...
	/*create a contact and then validate the phone number edit the phone and re validate*/
	...
	/*create a contact and then validate the Last name edit the last name and re validate*/
	...
	/*create a contact and then validate the first name edit the first name and re validate*/
	...
	/*create a contact and then validate the address edit the address and re validate*/
